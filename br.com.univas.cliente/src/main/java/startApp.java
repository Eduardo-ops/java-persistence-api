...
public class startApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n");
		System.out.println("Escolhe uma das opções abaixo para ajudar em seu trabalho:");
		System.out.println("\n");
		...
		do {
			...
			if (opcao == 2) {
				...
				if (opcao2 == 3) {
					...
					System.out.println("Digite o nome para alteração:");
					detalhe.setNome(nome = ler.next());
					System.out.println("Digite a idade para alteração:");
					detalhe.setIdade(idade = ler.nextInt());
					System.out.println("Digite a cidade para alteração:");
					detalhe.setCidade(cidade = ler.next());
					System.out.println("Digite o endereco para alteração:");
					detalhe.setEndereco(endereco = ler.next());
					detalhe.setDataCadastro(new Date());
				...
				if (opcao2 == 4) {
					...
					System.out.println("Informe o id do cliente detlhado a ser excluído:");
					id = ler.nextInt();
			...
			if (opcao == 3) {
				...
				if (opcao2 == 3) {
					...
					System.out.println("Digite a quantidade para alteração:");
					pedidos.setQuantidade(quantidade = ler.nextInt());
				...
				if (opcao2 == 4) {
					...
					System.out.println("Informe o id do pedido a ser excluído:");
					id = ler.nextInt();
